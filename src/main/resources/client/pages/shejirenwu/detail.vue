...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view class="container" :style='{"width":"100%","padding":"0px","position":"relative","background":"#ffffff","height":"auto"}'>
				...
				<view :style='{"margin":"16rpx 0 16rpx 0","borderColor":"#f0b8dd","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"dotted","height":"auto"}' class="detail-list-item title">
					<view :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#5fb959","textAlign":"right"}' class="lable">任务状态：</view>
					<view :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#666666","flex":"1"}' class="text">{{detail.renwuzhuangtai}}</view>
				</view>
				...
				<view class="detail-list-item rich" :style='{"margin":"24rpx 0 44rpx 0","borderColor":"#cccccc","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0 0 0px 0","background":"#ffffff","display":"block","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 24rpx 0 24rpx","margin":"0 0 0px","borderColor":"#f0b8dd","color":"#d84fa9","textAlign":"left","background":"#fff","borderWidth":"0 0 2rpx 0","width":"100%","lineHeight":"60rpx","fontSize":"32rpx","borderStyle":"dotted","fontWeight":"500"}'>任务详情</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"0","margin":"20rpx 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx 0 20rpx","margin":"0 20rpx 12rpx 0","color":"#333","borderRadius":"0","background":"#fff000","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="userid&&isAuth('shejirenwu','接单')" @tap="onAcrossTap('shejirenwujiedan','','renwuzhuangtai','已接单',renwuzhuangtaiCrossSelect[0])" class="cu-btn bg-brown round shadow-blur" >接单</button>
					<button :style='{"border":"0","padding":"0 20rpx 0 20rpx","margin":"0 20rpx 12rpx 0","color":"#333","borderRadius":"0","background":"#fff000","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('shejirenwu','接单')" @tap="onAcrossTap('shejirenwujiedan','','renwuzhuangtai','已接单',renwuzhuangtaiCrossSelect[0])" class="cu-btn bg-brown round shadow-blur" >接单</button>
				</view>
			</view>
	...
	export default {
		data() {
			return {
				...
				user: null,
				storeupFlag: 0,
                renwuzhuangtaiCrossSelect:'已接单,未接单'.split(','),
				count: 0,
				timer: null
			}
		},
		...
		async onShow(options) {
			...
			this.getStoreup();
			let cleanType = uni.getStorageSync('discussshejirenwuCleanType')
			if(cleanType){
				uni.removeStorageSync('discussshejirenwuCleanType')
				this.mescroll.num = 1
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('shejirenwu', this.id);
		...
		methods: {
			// 支付
			onPayTap(){
				uni.setStorageSync('paytable','shejirenwu');
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
								...
								await _this.$api.update('shejirenwu',_this.detail)
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				...
				uni.setStorageSync('crossTable','shejirenwu');
			...
			async init(){
				...
				let res = await this.$api.info('shejirenwu', this.id);
				this.detail = res.data;
				// 轮播图片
			...
			async upCallback(mescroll) {
                let res = await this.$api.list('discussshejirenwu', {
					page: mescroll.num,
					limit: 10,
					refid: this.id
				});
			...
			async onCommentTap() {
				...
				this.$utils.jump(`../discussshejirenwu/add-or-update?refid=${this.id}`)
			},
			onSHTap() {
				if(!this.user){
