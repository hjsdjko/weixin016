	...
	<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ffffff","height":"100%"}'>
		<form :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","background":"#ffffff","display":"block","height":"auto"}' class="app-update-pv">
			...
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px 0px 2rpx 0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="select">
				...
				<picker :style='{"width":"100%","flex":"1","height":"auto"}' @change="renwuzhuangtaiChange" :value="renwuzhuangtaiIndex" :disabled="true" :range="renwuzhuangtaiOptions">
			...
			<view :style='{"padding":"12rpx 0 12rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","borderWidth":"0 0 0px 0","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","fontWeight":"500"}' class="title">任务详情</view>
                <xia-editor ref="editor" :style='{"minHeight":"300rpx","border":"2rpx solid #eeeeee","padding":"20rpx","color":"#666666","background":"none","width":"100%","height":"auto"}' v-model="ruleForm.renwuxiangqing" placeholder="任务详情" @editorChange="renwuxiangqingChange"></xia-editor>
			</view>
	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`shejirenwu`, this.ruleForm.id);
		...
		methods: {
            renwuxiangqingChange(e) {
                this.ruleForm.renwuxiangqing = e
            },
			styleChange() {
				this.$nextTick(()=>{
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`shejirenwu`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`shejirenwu`, this.ruleForm);
						}else{
							await this.$api.add(`shejirenwu`, this.ruleForm);
						}
