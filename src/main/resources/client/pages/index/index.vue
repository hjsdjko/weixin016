	...
	<view :style='{"width":"100%","flexWrap":"wrap","background":"#ffffff","display":"flex","height":"100%"}'>
		...
		<!-- 商品列表 -->
			...
			<view class="title" :style='{"width":"calc(100% - 48rpx)","padding":"20rpx 80rpx 20rpx 80rpx","margin":"0 24rpx 24rpx 24rpx","textAlign":"center","background":"url(http://clfile.zggen.cn/20231201/929f7c0aed824bb3959e8ba0641392c8.gif) no-repeat center center / 100%","height":"auto"}'>
				<view :style='{"padding":"0","color":"#d84fa9","borderRadius":"0px","background":"none","display":"inline-block","fontSize":"36rpx","lineHeight":"40rpx","minWidth":"300rpx","fontWeight":"500"}'>学习资源</view>
				<text :style='{"margin":"0px 0 0 0","color":"#999","display":"inline-block","width":"auto","fontSize":"28rpx","lineHeight":"40rpx","float":"right"}' @tap="onPageTap('xuexiziyuan')">查看更多</text>
			</view>
		  ...
		  <view v-if="3 == 3" class="list-box style3" :style='{"padding":"24rpx 24rpx 24rpx 24rpx","margin":"0 0 0 0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<view @tap="onDetailTap('xuexiziyuan',product.id)" v-for="(product,index) in homexuexiziyuanlist" :key="index" class="list-item" :style='{"boxShadow":"0 0px 0px #00000030","padding":"0 0 24rpx 0","margin":"0 0 24rpx 0","borderColor":"#f0b8dd","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","display":"flex","width":"48%","borderStyle":"dashed","justifyContent":"space-between","height":"auto"}'>
			  			  			  			  			  <image :style='{"width":"38%","margin":"0 0px 0 0","objectFit":"cover","borderRadius":"0px","display":"block","height":"160rpx"}' class="list-item-image" mode="aspectFill" v-if="product.fengmian.substring(0,4)=='http'" :src="product.fengmian"></image>
			  <image :style='{"width":"38%","margin":"0 0px 0 0","objectFit":"cover","borderRadius":"0px","display":"block","height":"160rpx"}' class="list-item-image" mode="aspectFill" v-else :src="product.fengmian?baseUrl+product.fengmian.split(',')[0]:''"></image>
			  			  			  			  			  			  			  			  			  			  			  <view class="list-item-body" :style='{"width":"calc(58% - 0px)","padding":"0 0 0 0","margin":"0px 0 0 0","height":"auto"}'>
				                				<view :style='{"padding":"0 4rpx 0 4rpx","margin":"0 0 4rpx 0","overflow":"hidden","whiteSpace":"nowrap","color":"#333333","borderRadius":"0px","background":"#ffffff","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis","height":"48rpx"}' class="list-item-title">{{product.ziyuanmingcheng}}</view>
								                				                				                				                				                																																																											  </view>
			</view>
		  </view>
...
<script>
	...
	export default {
		...
		async onShow() {
			...
			res = await this.$api.list('xuexiziyuan', {
				page: 1,

				limit: 6
			});
			this.homexuexiziyuanlist = res.data.list
		},
